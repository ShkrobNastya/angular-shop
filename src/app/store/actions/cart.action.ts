...
export const getCartDataFailureAction = createAction(
  CartActionTypes.GET_CART_DATA_FAILURE
);

export const getCartDataAction = createAction(CartActionTypes.GET_CART_DATA);
...
export const deleteCartOrderFailureAction = createAction(
  CartActionTypes.DELETE_CART_ORDER_FAILURE
);
...
export const updateCartOrderFailureAction = createAction(
  CartActionTypes.UPDATE_CART_ORDER_SUCCESS
);
...
export const addCartOrderFailureAction = createAction(
  CartActionTypes.ADD_CART_ORDER_FAILURE
);
