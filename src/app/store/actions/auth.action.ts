...
export const registerFailureAction = createAction(AuthActionTypes.REGISTER_FAILURE);
export const loginAction = createAction(AuthActionTypes.LOGIN_USER, props<{ email: string; password: string }>());
