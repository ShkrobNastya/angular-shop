...
import { getCartDataAction, deleteCartOrderAction, getCartDataFailureAction, getCartDataSuccessAction, deleteCartOrderSuccessAction, deleteCartOrderFailureAction, updateCartOrderAction, updateCartOrderSuccessAction, updateCartOrderFailureAction, addCartOrderAction, addCartOrderSuccessAction, addCartOrderFailureAction  } from '../actions/cart.action';
...
export class CartEffect {
  getCartData$ = createEffect(() => {
    return this.actions$.pipe(
      ...
      switchMap(() =>  this.cartService.fetchCart()
      .pipe(
  ...
  deleteCartOrder$ = createEffect(() => {
    return this.actions$.pipe(
      ...
      switchMap((res) =>  this.cartService.deleteCartOrder(res.id)
      .pipe(
  ...
  updateCartOrder$ = createEffect(() => {
    return this.actions$.pipe(
      ...
      switchMap((res) =>  this.cartService.updateCartOrder(res.newOrder, res.id)
      .pipe(
  ...
  addCartOrder$ = createEffect(() => {
    return this.actions$.pipe(
      ...
      switchMap((res) =>  this.cartService.addCartOrder(res.newOrder)
      .pipe(
